  ...
  return (
    <div className="root h-screen">
      ...
      <div className="content flex">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link
                  ...
                  <span className="flex-1 ml-3 whitespace-nowrap">Roll call</span>
                </Link>
              </li>
              <div>
        ...
        <div className="h-5/6 outlet-container">
          <Outlet />
        </div>
      </div>
      <footer className="p-4 bg-white rounded-lg shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 fixed bottom-0 w-screen">

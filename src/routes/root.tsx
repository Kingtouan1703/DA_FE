        ...
        <div className="content flex w-8/12 mx-auto ">
          ...
          <aside className="w-64 h-full " aria-label="Sidebar ">
            <div className="overflow-y-auto py-4 px-3 bg-gray-50 p-2 rounded dark:bg-gray-800">
              ...
              <p className="tracking-tighter text-gray-500 md:text-lg dark:text-gray-400 mb-2">Gyms Infomation</p>
                <li>
                  <Link
                    to="/"
                ...
                <p className="tracking-tighter text-gray-500 md:text-lg dark:text-gray-400 mb-2">Admin</p>
                <li>
                  <Link
                    to='admin'
                    className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                ...
                <p className="tracking-tighter text-gray-500 md:text-lg dark:text-gray-400 mb-2">User</p>
                <Link to="/user">
                ...
                <li>
                  <Link
                    ...
                    <span className="flex-1 ml-3 whitespace-nowrap">Extend your time</span>
                  </Link>
                </li>
                <p className="tracking-tighter text-gray-500 md:text-lg dark:text-gray-400 mb-2">Action</p>
                <div>
                  <div className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                    <svg
                      aria-hidden="true"
          ...
          {/* body */}
          <div className="w-full outlet-container">
            <Outlet />
          </div>
        </div>
      </div>
      {/* footer */}
      <footer className="p-4 bg-white shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 fixed bottom-0 w-full">
